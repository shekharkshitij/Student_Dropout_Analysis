...
def analyze_dropout():
    ...
    previous_qualification = 1 if previous_qualification_var.get() == "High School Diploma" else 0  # Replace with your actual values
    nationality = 1 if nationality_var.get() == 'UK' else 0  # Replace with your actual values
    mothers_qualification = 1 if mothers_qualification_var.get() == "High School Diploma" else 0  # Replace with your actual values
    fathers_qualification = 1 if fathers_qualification_var.get() == "High School Diploma" else 0  # Replace with your actual values
    mothers_occupation = 1 if mothers_occupation_var.get() == 'Other' else 0  # Replace with your actual values
    fathers_occupation = 1 if fathers_occupation_var.get() == 'Other' else 0  # Replace with your actual values
    ...
    scholarship_holder = 1 if scholarship_holder_var.get() == 'No' else 0
